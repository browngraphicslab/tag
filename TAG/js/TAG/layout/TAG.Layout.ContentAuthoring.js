TAG.Util.makeNamespace("TAG.Layout.ContentAuthoring");

/**
*This is the layout for entering from startpage to authoring mode.
**/
TAG.Layout.ContentAuthoring = function () {
    "use strict";
    ...
    (function init() {
        ...
        **/
        ...
        function GeneralSettings() {
            new ChangeView((new TAG.Authoring.SettingsView()));
        }
        /*generate exhibition setting*/
        function ExhibitionSettings() {
            new ChangeView((new TAG.Authoring.SettingsView('exhibitions')));
        }
