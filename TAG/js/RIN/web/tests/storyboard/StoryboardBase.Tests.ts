...
module rin.nonlinearStoryboardTests {
    ...
    var currentStateValue: number = 0;

    var getCurrentState = function (): Keyframe {
        return {
            "offset": 0,
            "state": {
    ...
    var genBuildSmoothTransitionTrajectory = function (tb: TrajectoryBuilder) {

        //
        // We return this function which has access to TrajectoryBuilder tb above.
        //
        return function (traj1: ITrajectory, t1: number, traj2: ITrajectory, t2: number, pause: bool) {
            var preKf: Keyframe = null;
            var prePreKf: Keyframe = null;
            var postKf: Keyframe = null;
            var postPostKf: Keyframe = null;
            var DELTA = 1.0;
            ...
            var resultTrajectory: ITrajectory;
