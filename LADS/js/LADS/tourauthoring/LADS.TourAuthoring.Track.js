...
LADS.TourAuthoring.Track = function (spec, my) {
    ...
    */
    ...
    var grTrack = LADS.Util.makeManipulatable(my.track[0], {
    ...
    */
    function setDisplaySelected(currentDisplay) {
        ...
        if (currentDisplay.getType() === 4 || currentDisplay.getType() === 2) {
            currentDisplay.getMainD().css('background-color', LADS.TourAuthoring.Constants.selectedInkDisplayColor);
        } else {
            currentDisplay.getMainD().css('background-color', LADS.TourAuthoring.Constants.selectedDisplayColor);
        }
    }
    ...
    */
    function setDisplayDeselected(currentDisplay, keepDisplays) {
        ...
        if (currentDisplay.getType() === 4 || currentDisplay.getType() === 2) {
            currentDisplay.getMainD().css('background-color', LADS.TourAuthoring.Constants.inkDisplayColor);
        } else if (currentDisplay.getType() === 1) {
            currentDisplay.getMainD().css('background-color', 'rgba(129, 173, 98, 0.8)');
        } else {
            currentDisplay.getMainD().css('background-color', LADS.TourAuthoring.Constants.displayColor);
        }
    }
    ...
    */
    function boundHelper(currDisplay, hasZeroFadeout) { // deal with fixing bounds for ink dragging here
        ...
        if (loc === LADS.TourAuthoring.DisplayParts.main) {
            ...
            //            rightbound = my.displays[i + 1].getStart() - LADS.TourAuthoring.Constants.esOffset;//my.displays[i + 1] === dataHolder.findNextDisplay(arrayPos, currDisplay)
            //        }
            //        if (my.type === LADS.TourAuthoring.TrackType.ink && my.
            //) {
